                                ...
                                <div class="form-validation">
                                    <form class="form-valide"  enctype="multipart/form-data" action="../Actions/Add_product.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control"  name="product_desc" rows="5" placeholder="Product description"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control"  name="product_keywords" placeholder="Product keywords">
                                            </div>
                                        </div>
                                        <div class="form-group row">
